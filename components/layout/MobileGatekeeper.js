...
export default function MobileGatekeeper({ children }) {
  ...
  if (!isMobile) {
    return (
      <div className="fixed inset-0 bg-[#0f1117] flex flex-col items-center justify-center p-8 text-center overflow-hidden">
        ...
        <motion.div
          ...
          className="z-10 max-w-2xl bg-black/40 backdrop-blur-3xl p-12 rounded-[3rem] border border-white/10 shadow-[0_0_100px_rgba(0,0,0,0.5)]"
        >
          <div className="relative w-32 h-32 mx-auto mb-10">
             <Image src="/logo.png" alt="LearnExcel" fill className="object-contain" />
          </div>

          <h1 className="text-6xl font-black mb-6 bg-clip-text text-transparent bg-gradient-to-b from-white to-slate-500 leading-tight">
