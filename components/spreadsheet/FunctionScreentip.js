...
export default function FunctionScreentip({ activeFunction, visible }) {
  ...
  return (
    <div className="absolute z-[100] bottom-full mb-2 bg-slate-800 border border-white/10 rounded-md px-3 py-2 shadow-2xl text-xs font-mono animate-in slide-in-from-bottom-1 duration-150">
